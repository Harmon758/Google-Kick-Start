.. _Problem A. Lazy Spelling Bee: https://code.google.com/codejam/contest/8264486/dashboard#s=p0
...
The contestant's answer word A is acceptable if it is the same length as the
target word, and the i-th letter of A is either the i-th, (i-1)th, or (i+1)th
letter of W, for all i in the range of the length of A.
(The first letter of A must match either the first or second letter of W,
since the 0th letter of W doesn't exist. Similarly, the last letter of A must
match either the last or next-to-last letter of W.)
...
**T** test cases follow; each consists of one line with a string consisting
only of lowercase English letters (``a`` through ``z``).

Output
------
For each test case, output one line containing "Case #x: y",
where x is the test case number (starting from 1)
and y is the number of distinct acceptable answer words, modulo |10^9| + 7.
